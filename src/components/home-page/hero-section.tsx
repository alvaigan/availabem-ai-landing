...
const HeroSection = () => {
    return (
        <section
            id="inicio"
            className="min-h-screen bg-[#C6ECFA] relative overflow-hidden"
        >
            <Image
                src="/hero-bg.svg"
                alt="Logo"
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
                <div className="mb-8">
                    <span className="inline-flex items-center px-4 py-2 rounded-md text-sm font-medium bg-gradient-to-r from-[#0085FF] to-[#00E113] text-white">
                        <Image
                            src="/lighting-icon.svg"
                            alt="Logo"
                            width={0}
                            height={0}
                            className="w-5 h-5 inline me-2"
                        />{" "}
                        Revolução de RH com IA
                    </span>
                </div>
                ...
                <p className="text-sm md:text-base mb-8 max-w-3xl leading-relaxed opacity-90">
                    Crie avaliações de desempenho justas e éticas inspiradas na
                    psicodinâmica do trabalho de Christophe Dejours. Colete insights
                    colaborativamente, analise com IA e gere formulários de avaliação
                    personalizados para aumentar a saúde mental e produtividade da
                    organização.
                </p>
