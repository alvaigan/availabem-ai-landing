        ...
        <div className="my-40 relative">
            ...
            <div className="flex flex-row items-center justify-center text-center gap-10 z-10 relative">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p>
                        Insira nome da empresa, departamento, cargo e lista de stakeholders
                        com emails e nomes.
                    </p>
                </div>
                <div>
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <p>
                            E-mails profissionais são enviados perguntando sobre o que faz um
                            bom e admirável profissional.
                        </p>
                    </div>
                </div>
                <div>
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <p>
                            IA agrupa temas, filtra padrões prejudiciais e classifica KPIs vs
                ...
                <div>
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <h2 className="font-semibold text-xl">
                            Receber Formulário Personalizado
                        </h2>
                        <p>
                            Receba um formulário de avaliação estruturado com categorias,
                            perguntas e escalas de classificação.
                        </p>
                    </div>
                </div>
            </div>
