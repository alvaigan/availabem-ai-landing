...
const FeaturesTimeline = () => {
  return (
    <div className="w-full lg:w-3/4">
      <div className="relative grid grid-cols-2 mt-10 mb-20 hidden sm:hidden md:grid">
        ...
        <div className="relative flex flex-col gap-2 px-5 my-10 ml-10 mr-20">
          ...
          <Image
            src="/collaborate-group-icon.svg"
            alt="Logo"
            width={0}
            height={0}
            className="w-10 h-10"
            ...
            fetchPriority="high"
          />
          <h2 className="font-bold text-xl bg-gradient-to-r from-[#0085FF] to-[#00E113] bg-clip-text text-transparent">
            Insights Colaborativos
          </h2>
          <p>
            Colete feedback autêntico de stakeholders em toda sua organização
          </p>
        </div>
    ...
    {/*  Mobile */}
      ...
      <div className="relative grid grid-row-2 mt-10 mb-5 sm:grid md:hidden text-center">

        <div className="relative flex flex-col gap-2 px-5 my-10 items-center justify-center">
          <Image
            src="/collaborate-group-icon.svg"
            alt="Logo"
            width={0}
